        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    account_kind = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_action_codes", x => x.id);
                    table.CheckConstraint("ck_action_codes_expiry", "expires_at_utc > created_at_utc");
                    table.ForeignKey(
                        name: "fk_action_codes_users_user_id",
                        column: x => x.user_id,
                        principalSchema: "identity_access",
            ...
            migrationBuilder.CreateIndex(
                name: "ux_action_codes_active_user_purpose",
                schema: "identity_access",
                table: "action_codes",
            ...
            migrationBuilder.CreateIndex(
                name: "ux_action_codes_code_hash",
                schema: "identity_access",
                table: "action_codes",
                column: "code_hash",
                unique: true);
