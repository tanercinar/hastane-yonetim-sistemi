...
[Migration("20260829030000_AddMedicationStockAndTransactions")]
partial class AddMedicationStockAndTransactions
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("HospitalManagement.Modules.Pharmacy.Domain.MedicationCatalogItem", b =>
            {
                ...
                b.HasIndex("Code")
                    .IsUnique()
                    .HasDatabaseName("ux_medication_catalog_items_code");
        ...
        modelBuilder.Entity("HospitalManagement.Modules.Pharmacy.Domain.MedicationStockItem", b =>
            {
                ...
                b.HasIndex("MedicationCatalogItemId", "Location", "LotNumber")
                    .IsUnique()
        ...
        modelBuilder.Entity("HospitalManagement.Modules.Pharmacy.Domain.Prescription", b =>
            {
                ...
                b.HasIndex("DepartmentId")
                    .HasDatabaseName("ix_prescriptions_department_id");
